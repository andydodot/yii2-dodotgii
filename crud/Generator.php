    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($tableSchema === false || !isset($tableSchema->columns[$attribute])) {
            if (preg_match('/^(password|pass|passwd|passcode)$/i', $attribute)) {
                return "'$attribute'=>['type'=> TabularForm::INPUT_PASSWORD,'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...']],";
                //return "\$form->field(\$model, '$attribute')->passwordInput()";
            } else {
                return "'$attribute'=>['type'=> TabularForm::INPUT_TEXT, 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...']],";
        ...
        if ($column->phpType === 'boolean') {
            ...
            return "'$attribute'=>['type'=> Form::INPUT_CHECKBOX, 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...']],";
        } elseif ($column->type === 'text') {
            //return "\$form->field(\$model, '$attribute')->textarea(['rows' => 6])";
            return "'$attribute'=>['type'=> Form::INPUT_TEXTAREA, 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...','rows'=> 6]],";
            ...
            if ($column->phpType !== 'string' || $column->size === null) {
                ...
                return "'$attribute'=>['type'=> Form::".$input.", 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...']],";
            } else {
                //return "\$form->field(\$model, '$attribute')->$input(['maxlength' => $column->size])";
                return "'$attribute'=>['type'=> Form::".$input.", 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', '".$attributeLabels[$attribute]."').'...', 'maxlength'=>".$column->size."]],";
            }
        }
    }
